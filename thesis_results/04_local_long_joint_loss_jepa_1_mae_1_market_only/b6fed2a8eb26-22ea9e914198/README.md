...
- Config: `config/experiments/chapter5_candidates/stage04_market_only/04_local_long_joint_loss_jepa_1_mae_1_market_only.json`
- Result root: `results/04_local_long_joint_loss_jepa_1_mae_1_market_only`
...
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/AAPL/seed_42/last_model_comparison_20260905_234526.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/AAPL/seed_44/last_model_comparison_20260905_234936.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/AAPL/seed_46/last_model_comparison_20260905_234936.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/AVGO/seed_42/last_model_comparison_20260905_235346.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/AVGO/seed_44/last_model_comparison_20260905_235345.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/AVGO/seed_46/last_model_comparison_20260905_235756.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/NVDA/seed_42/last_model_comparison_20260905_234116.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/NVDA/seed_44/last_model_comparison_20260905_234116.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/NVDA/seed_46/last_model_comparison_20260905_234525.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/TSLA/seed_42/last_model_comparison_20260905_235756.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/TSLA/seed_44/last_model_comparison_20260906_000205.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/TSLA/seed_46/last_model_comparison_20260906_000206.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/WMT/seed_42/last_model_comparison_20260906_000615.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/WMT/seed_44/last_model_comparison_20260906_000615.csv`
- `results/04_local_long_joint_loss_jepa_1_mae_1_market_only/local_long/WMT/seed_46/last_model_comparison_20260906_000957.csv`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Local-MAE/Long-JEPA | -0.001758 | -0.002876 | -0.0006392 | 0.125 | 5 | 12 | 15 |
...
- Immutable snapshot: `b6fed2a8eb26-22ea9e914198`
