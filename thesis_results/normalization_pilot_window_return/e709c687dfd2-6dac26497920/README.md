...
| --- | --- | --- | --- |
| Shared-target JEPA--MAE | 3 | 3 | 100 |
| GRU | 3 | 3 | 100 |
| Naive-last | 3 | 3 | 100 |
| Drift | 3 | 3 | 100 |
| Mean-context | 3 | 3 | 100 |
...
- `results/normalization_pilot_window_return/random/NVDA/seed_42/last_model_comparison_20260827_074613.csv`
- `results/normalization_pilot_window_return/random/NVDA/seed_44/last_model_comparison_20260827_074631.csv`
- `results/normalization_pilot_window_return/random/NVDA/seed_46/last_model_comparison_20260827_074650.csv`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Shared-target JEPA--MAE | 0.0002061 | 0.0002061 | 0.0002061 | 1 | 0 | 0 | 3 |
| GRU | 0.0002115 | 0.0002115 | 0.0002115 | 1 | 0 | 0 | 3 |
...
- Immutable snapshot: `e709c687dfd2-6dac26497920`
