...
- Config: `config/experiments/top10_h1_without_sentiment.json`
- Result root: `results/top10_h1_without_sentiment`
- Expected equities: NVDA
- Expected seeds: 42
- Strategies: random, local_long
- Canonical baseline/GRU strategy: `random`
- Canonical rows: 6
- Audit issues: 0 errors and 2 warnings

| method | available_runs | expected_runs | coverage_pct |
| --- | --- | --- | --- |
| Shared-target JEPA--MAE | 1 | 1 | 100 |
| Local-MAE/Long-JEPA | 1 | 1 | 100 |
| GRU | 1 | 1 | 100 |
| Naive-last | 1 | 1 | 100 |
| Drift | 1 | 1 | 100 |
| Mean-context | 1 | 1 | 100 |
...
- `results/top10_h1_without_sentiment/local_long/NVDA/seed_42/last_model_comparison_20260825_214403.csv`
- `results/top10_h1_without_sentiment/random/NVDA/seed_42/last_model_comparison_20260825_214325.csv`

Excluded inventory rows: 4.
- duplicate deterministic baseline; reference strategy selected: 3
- alternate strategy-specific GRU; reference strategy selected: 1
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Shared-target JEPA--MAE | 0.0001226 | 0.0001226 | 0.0001226 | 1 | 0 | 0 | 1 |
| Local-MAE/Long-JEPA | 0.0005747 | 0.0005747 | 0.0005747 | 1 | 0 | 0 | 1 |
| GRU | 0.0003436 | 0.0003436 | 0.0003436 | 1 | 0 | 0 | 1 |
...
- Seed: 42
- Rolling step: 0
- Target dates: 2025-04-01T00:00:00
...
| figures/fig_direction_accuracy_heatmap.pdf | omitted | Direction-accuracy observations were unavailable. |
| figures/fig_direction_by_horizon.pdf | omitted | Raw horizon predictions or supported horizon directions were unavailable. |
...
- Immutable snapshot: `4e475d2902eb-2cfedbcbb641`
